"""Tests for the ``exploratory.example.src.example_package`` package."""
...
def test___version___is_correctly() -> None:
    """Test the ``__version__`` attribute is correct."""
    assert example_package.__version__ == "0.1.0"
